...
import net.penyo.tsington.v0.ConfigClassBasedTsingtonDataSource;
import net.penyo.tsington.v0.ClassPathYmlBasedTsingtonDataSource;
...
public class FlexibleMechanismTest {
  ...
  public void testExpandWithConfigClass() {
    try (TsingtonDataSource tds = new ConfigClassBasedTsingtonDataSource(TsingtonConfig.class)) {
      expand(tds);
      assertEquals(tds.getCapacity(), 16);
    }
  }
